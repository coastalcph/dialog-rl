...
do
        ...
        python -m run --train_domains $domain --eval_domains $domain --lr 0.0001 --epochs 1000 --gpu $gpu -n p/single-$domain --max_dev_dialogs 150 --delexicalize_labels --elmo --pooled --batch_size 16 --train_strict --patience 10 &> logs/single-$domain.log 
